...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4)# programme lineaine sage
...
p.add_constraint(x[_sage_const_2 ] <= (y[_sage_const_1 ] + y[_sage_const_3 ])/_sage_const_2 )  # presence d'une arete
p.add_constraint(x[_sage_const_3 ] <= (y[_sage_const_3 ] + y[_sage_const_4 ])/_sage_const_2 )  # presence d'une arete
