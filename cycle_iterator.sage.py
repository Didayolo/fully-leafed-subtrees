...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_6 = Integer(6)#!/usr/bin/env python
...
def all_cycle(g):
    ...
    while(n - _sage_const_1  > _sage_const_0 ):
...
def display_all_cycle(cycles):
    for i, c in enumerate(cycles):
        print str(i+_sage_const_1 ) + " : " + str(c).replace('frozenset([','{').replace('])','}')
...
#r"""
g = graphs.CompleteGraph(_sage_const_6 )
